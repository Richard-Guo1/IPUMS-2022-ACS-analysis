...
NY <- subset(NY, select = -c(YEAR, SAMPLE, SERIAL, CBSERIAL, HHWT, CLUSTER, STATEICP, STRATA, GQ, PERNUM, PERWT, RACED, CITIZEN, EDUC, EDUCD, DEGFIELD, DEGFIELDD, TRANWORK))

# Remove rows with missing/NA data
cleaned <- subset(NY, NY$SEX != 9 & NY$UHRSWORK != 0)
...
cleaned <- cleaned[,c(4,1,2,6,8,7,3,5)]
